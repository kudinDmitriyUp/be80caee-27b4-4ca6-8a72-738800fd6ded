...
export const metadata: Metadata = {
  title: "Ukraine Information Portal | Facts, Updates, How to Help",
  description: "Access verified information about Ukraine, understand the current situation, and discover ways to support the Ukrainian people. Get facts, latest updates, and resources.",
  keywords: "Ukraine, information, news, humanitarian aid, support, facts, updates",
  metadataBase: new URL("https://ukraine-info.org"),
  alternates: {
    canonical: "https://ukraine-info.org"
  },
  openGraph: {
    title: "Ukraine Information Portal",
    description: "Stay informed about Ukraine and learn how you can help the Ukrainian people.",
    type: "website",
    siteName: "Ukraine Information Portal",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766151789609-jof3155g.jpg",
        alt: "Ukraine Information Portal"
      }
    ]
  },
  twitter: {
    ...
    title: "Ukraine Information Portal",
    description: "Get verified information about Ukraine and ways to support.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766151789609-jof3155g.jpg"]
  },
  robots: {
    index: true,
    follow: true
